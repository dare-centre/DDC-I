...
if (use_scaler) {
  ...
  test_y <- datawizard::rescale(test_y[,], to = c(0, 1), range = range(train_y))
  if (val_split) {
    val_y <- datawizard::rescale(val_y, to = c(0, 1), range = range(train_y))
  }
  train_y <- datawizard::rescale(train_y, to = c(0, 1))
